...
namespace MathParserTK
{
    ...
    public class MathParser
    {
        ...
        private const string Dice = OperatorMarker + "d";
            ...
            else
            {
                ...
                switch (token)
                {
                    ...
                    case Dice:
                        if(arg2 <= 0)
                        {
                            throw new ArgumentException("number of dice faces must be more than 0");
                        }
                        else if (arg1 < 0)
                        {
                            throw new ArgumentException("number of dices must be at least 0");
                        }
                        else if(arg1 == 0)
                        {
                            rst = 1;
                        ...
                        else
                        {
                            ...
                            for (int i = 0; i < arg1; arg1--)
                            {
                                int rs = random.Next(1, (int)arg2 + 1);
