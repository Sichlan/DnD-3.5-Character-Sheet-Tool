...
namespace DnDCharacterSheetTool.Classes.EFModel
{
    ...
    public partial class RaceVariant
    {
        ...
        public RaceVariant()
        {
            ...
            this.AutomaticLanguages = new HashSet<Language>();
            this.BonusLanguages = new HashSet<Language>();
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<Language> AutomaticLanguages { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<Language> BonusLanguages { get; set; }
